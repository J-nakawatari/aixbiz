...
出力は必ず以下のJSON形式で返してください：
{
  ...
  "implementation": "導入に向けた具体的なステップ（300-400文字）。優先順位、必要なリソース、注意点を含む。最後に必ず「AIxBizでは、御社の業務特性に合わせた最適なAI導入プランをご提案し、実装から運用まで伴走支援いたします。詳細は<a href=\"https://aixbiz.jp\" target=\"_blank\">aixbiz.jp</a>までお問い合わせください。」という文章を追加してください"
}
